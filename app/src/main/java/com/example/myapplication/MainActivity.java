...
public class MainActivity extends AppCompatActivity {
    ...
    public void add(View v)
    {
        ...
        EditText num1EditText = (EditText) findViewById(R.id.num1EditText1);
        EditText num2EditText = (EditText) findViewById(R.id.num2EditText2);
    ...
    public void div(View v)
    {
        ...
        //set the text for the answer
        ansTextView.setText("Answer: " + div);
    }
    public void mult(View v)
    {
        ...
        //set the text for the answer
        ansTextView.setText("Answer: " + mult);
    }
